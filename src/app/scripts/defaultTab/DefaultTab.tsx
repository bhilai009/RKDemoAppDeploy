 ...
 */
export interface IDefaultTabState extends ITeamsBaseComponentState {
    entityId?: string;
}
 ...
 */
export interface IDefaultTabProps {
 ...
 */
export class DefaultTab extends TeamsBaseComponent<IDefaultTabProps, IDefaultTabState> {
