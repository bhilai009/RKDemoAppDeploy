...
export interface IDefaultTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IDefaultTabRemoveProps {

}

/**
 * Implementation of DefaultTab remove page
 */
export class DefaultTabRemove  extends TeamsBaseComponent<IDefaultTabRemoveProps, IDefaultTabRemoveState> {
